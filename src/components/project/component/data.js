...
export const projects = [
    ...
    },
    {
        ...
        image: Siperu,
        description:
            "SIPERU is a web-based room rental platform that facilitates easy and eficient room booking and management, helping to increase room utilization and minimize booking conflict.",
        technology: [
            "HTML 5",
            "Bootstrap",
            "CSS 3",
